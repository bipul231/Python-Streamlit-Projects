...
#st.subheader('IT is not what is is 010')
...
image = Image.open('Image/survey1.jpg')
print(image)
col1.image(image,
        caption='Designed by unsplash / Free**pikct',
        use_column_width=True)
col2.dataframe(df[mask])



# --- To Remove Null Values in Participants data ---
df_participants.dropna(inplace=True)

# --- Next Section Pie chart ---
